...
func (r *Repository) DeleteBook(context *fiber.Ctx) error {
	...
	if id == "" {
		context.Status(http.StatusInternalServerError).JSON(&fiber.Map{"message": "id can't be empty"})
		return nil
	}
...
func (r *Repository) SetupRoutes(app *fiber.App) {
	api := app.Group("/api") //all will start with /api
